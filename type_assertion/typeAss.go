...
func ExtractFancyNumber(fnb FancyNumberBox) int {
	// Type assertion to check if fnb is of type FancyNumber
...
func DescribeFancyNumberBox(fnb FancyNumberBox) string {
	isFancy := ExtractFancyNumber(fnb)
	if isFancy != 0 {
		return fmt.Sprintf("This is a fancy box containing the number %.1f", float64(isFancy))
	}
